...
pageReviews reviewLinks reviewTags reviews = makePage "reviews" "Reviews" customLayout defaultPage $ do
    row $ do
        H.div ! class_ "col-lg-2 py-1 mb-0 order-0" $ reviewLinks
        H.div ! class_ "col-lg-8 py-2 mb-0 bg-page order-lg-1 order-2" $ reviews
        H.div ! class_ "col-lg-2 py-1 mb-1 order-lg-2 order-1" $ reviewTags
