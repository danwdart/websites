...
socialIconBBanned linkHref linkTitle iconName = (a ! class_ "social" ! href linkHref ! A.style "color:black" ! A.title linkTitle ! target "_blank" ! rel "noopener") . (H.span ! class_ "fa-stack fa-1x" ! A.style "font-size: 0.5em; height: 2.6em") $ (do
...
socialIconSBanned linkHref linkTitle iconName = (a ! class_ "social" ! href linkHref ! A.style "color:black" ! A.title linkTitle ! target "_blank" ! rel "noopener") . (H.span ! class_ "fa-stack fa-1x" ! A.style "font-size: 0.5em; height: 2.6em") $ (do
