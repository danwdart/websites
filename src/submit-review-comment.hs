...
handler request = do
    ...
    let reviewId = lookupQS "reviewId"
    ...
    runGitHubT state $ do
        ...
        void $ commitNewFile branch reviewId commentId commentRecord
...
commitNewFile branch reviewId commentId commentRecord = queryGitHub GHEndpoint
  { GH.method = PUT
  , endpoint = "/repos/:owner/:repo/contents/:path"
  , endpointVals =
    [ "owner" := owner
    , "repo" := repo
    , "path" := "reviews/comments/" <> reviewId <> "/" <> commentId
    ]
  , ghData =
