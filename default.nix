...
let
  ...
  myHaskellPackages = nixpkgs.pkgs.haskell.packages.${compiler}.override {
    overrides = self: super: rec {
      ...
      aeson-diff = (nixpkgs.pkgs.haskell.lib.doJailbreak (self.callCabal2nix "aeson-diff" (builtins.fetchGit {
      ...
      # not in nix
      semialign = nixpkgs.pkgs.haskell.lib.doJailbreak (
      ...
      JuicyPixels = nixpkgs.pkgs.haskell.lib.doJailbreak (super.JuicyPixels);
      blaze-markup = nixpkgs.pkgs.haskell.lib.doJailbreak (super.blaze-markup);
      ...
      charset = nixpkgs.pkgs.haskell.lib.doJailbreak (self.callCabal2nix "charset" (builtins.fetchGit {
        url = "https://github.com/ekmett/charset.git";
        rev = "4f456a30513212bcb7c7ec14ab25880a43a3aa18";
      }) {});
      websockets = nixpkgs.pkgs.haskell.lib.doJailbreak (super.websockets);
      hslua = nixpkgs.pkgs.haskell.lib.doJailbreak (super.hslua);
      iproute = nixpkgs.pkgs.haskell.lib.doJailbreak (self.callCabal2nix "iproute" (builtins.fetchGit {
        url = "https://github.com/kazu-yamamoto/iproute.git";
        rev = "f387a37e07a4074d8e2b912834d93b6628d0befd";
      }) {});
      network-byte-order = (nixpkgs.pkgs.haskell.lib.doJailbreak (self.callCabal2nix "network-byte-order" (builtins.fetchGit {
      ...
      modern-uri = nixpkgs.pkgs.haskell.lib.doJailbreak (super.modern-uri);
      ...
      sop-core = (nixpkgs.pkgs.haskell.lib.doJailbreak (self.callCabal2nixWithOptions "sop-core" (builtins.fetchGit {
        url = "https://github.com/danwdart/generics-sop.git";
        rev = "39386037d49bd21871a6479eaba9f4d5f4dbdf10";
      }) "--subpath sop-core" {}));
      generics-sop = nixpkgs.pkgs.haskell.lib.doJailbreak (self.callCabal2nixWithOptions "generics-sop" (builtins.fetchGit {
        url = "https://github.com/danwdart/generics-sop.git";
        rev = "39386037d49bd21871a6479eaba9f4d5f4dbdf10";
      }) "--subpath generics-sop" {});
      vault = nixpkgs.pkgs.haskell.lib.doJailbreak (super.vault);
      unicode-transforms = nixpkgs.pkgs.haskell.lib.doJailbreak (super.unicode-transforms);
      # https://github.com/haskellari/tree-diff/pull/59
      tree-diff = nixpkgs.pkgs.haskell.lib.doJailbreak (self.callCabal2nix "tree-diff" (builtins.fetchGit {
      ...
      cabal-doctest = nixpkgs.pkgs.haskell.lib.doJailbreak (self.callCabal2nix "cabal-doctest" (builtins.fetchGit {
